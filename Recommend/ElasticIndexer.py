        ...
        for i, line in enumerate(self.encoded):
            yield {
                ...
                "_source": {
                    ...
                    "video_writer" : line["video_writer"],
...
if __name__ == "__main__":
    # 해당 비디오를 정보에 대하여 인덱싱
    indexer = ElasticIndexer("video_titles.csv", ["description", "video_name", "video_writer", "song_name", "artist", "instrument"], [True, False, False, False, False, False], verbose=True)
    indexer.index()
